          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              <p>
                ...
                collaborating within <span>Agile workflows</span> and delivering
                full-lifecycle solutions across both front-end and back-end
                systems.
              </p>
            </div>
            <div className="col-lg-6 dial_div">
              <DialIcons size={350} />
            </div>
          </div>
        </div>
